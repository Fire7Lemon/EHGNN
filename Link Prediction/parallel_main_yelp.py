...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='PubMed', help='数据集（默认 PubMed；本脚本加载 Yelp）')
    ...
    parser.add_argument('--val_epochs', type=int, default=1, help='验证间隔（步）')
...
# Yelp 并行版：joblib 并行预计算各 meta-path 相似矩阵
